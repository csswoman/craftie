            ...
            return (
              <li key={column.id} className="relative flex min-h-0 min-w-0 flex-1">
                <button
                  ...
                  className={`group/slot relative flex w-full cursor-pointer border-0 bg-transparent text-inherit transition-shadow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 ${
                    expanded
                      ? isWideLayout
                ...
                {!showShades ? (
                  <div
                    className={`${expanded ? 'min-w-0 flex-1 text-left' : 'w-full text-center'} ${
                      mobileExpanded ? 'pr-1' : ''
                    }`}
                  >
                    <span
