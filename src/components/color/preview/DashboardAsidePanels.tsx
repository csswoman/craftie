  ...
  return (
    <div className="grid gap-4">
      ...
      >
        ...
        <PreviewSlotTarget slot="text" onEditSlot={onEditSlot} className="mt-1.5" style={headingStyle(fonts)}>
          Revenue quality
        </PreviewSlotTarget>
        <PreviewSlotTarget slot="mutedText" onEditSlot={onEditSlot} className="mt-3" style={bodyStyle(fonts, colors.mutedText)}>
